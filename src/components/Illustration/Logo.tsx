...
/**
 * A responsive, scalable SVG logo.
 * - Uses `fill="currentColor"` so color adapts to parent text color (e.g., `text-base-content`).
 * - In your usage, you can pass Tailwind classes like `w-full h-auto` or `w-8 h-8` to control size.
...
const Logo: React.FC<LogoProps> = (props) => {
  return (
    <svg
      ...
      // Spread any additional props (like className, width, height, etc.)
      {...props}
      // For responsive sizing, you can pass className="w-full h-auto" or similar.
    >
      <defs>
        <linearGradient id="header-logo" x1="0%" y1="0%" x2="100%" y2="0%">
...
export default Logo;
// src/components/Illustration/Logo.tsx
